...
function isCollided(car1, car2){
    ...
    return !((car1Rect.bottom<car2Rect.top) || (car1Rect.top>car2Rect.bottom) || (car1Rect.right<car2Rect.left) || (car1Rect.left>car2Rect.right)) 
...
function endGame(){
    ...
    startContainer.innerHTML = "Game Over !<br> Your Final Score is : " + player.score +"<br> Click here to Restart the Game.";
    player.score = 0;
}
